...
function Demo() {
  ...
  const getContainer: IAnchorProps['getContainer'] = () => warpRef.current
  return (
    <div style={{ height: '300px', width: '100%', position: 'relative' }}>
      <Row>
        <Col span={18}>
          <div ref={warpRef} style={{ height: '300px', overflow: 'scroll' }}>
            <div id="part-1" style={{ height: '200px', background: 'rgba(255,0,0,0.02)', marginTop: '30px' }}>
              Part 1
            </div>
        ...
        <Col span={6}>
          <Anchor affix={false} bounds={30} getContainer={getContainer}>
