...
describe('Grid', () => {
  ...
  describe('6. api test', () => {
    ...
    it('when typeof gutter is number', () => {
      ...
      expect(wrapper.find('div').first()).toHaveStyle('margin', '0 -20px')
    })

    it('when typeof gutter is object', () => {
      const wrapper = mount(<Row gutter={{ xs: 8, sm: 16, md: 24 }} />)
      expect(wrapper.find('div').first()).toHaveStyle('margin', '0 -24px')
    })
    ...
    it('when typeof gutter is object array', () => {
      ...
      expect(wrapper1.find('div').first()).toHaveStyle({ 'row-gap': '24px' })
      expect(wrapper2.find('div').first()).toHaveStyle({ 'row-gap': '12px' })
    })
    ...
    it('should responsive', () => {
      ...
      expect(wrapper.find('div').first()).toHaveStyle({ 'row-gap': '24px', margin: '0 -24px' })
      ...
      wrapper.update()
      expect(wrapper.find('div').first()).toHaveStyle({ 'row-gap': '8px', margin: '0 -8px' })
      ...
      wrapper.update()
      expect(wrapper.find('div').first()).toHaveStyle({ 'row-gap': '16px', margin: '0 -16px' })
      ...
      wrapper.update()
      expect(wrapper.find('div').first()).toHaveStyle({ 'row-gap': '32px', margin: '0 -32px' })
      ...
      wrapper.update()
      expect(wrapper.find('div').first()).toHaveStyle({ 'row-gap': '40px', margin: '0 -40px' })
