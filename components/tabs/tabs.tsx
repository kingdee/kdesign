...
const Tabs: React.FC<ITabsProps> = (props) => {
  const { getPrefixCls, prefixCls, compDefaultProps: userDefaultProps, isMobile } = useContext(ConfigContext)
  ...
  const renderTabPane = () => {
    ...
    const renderTabWrap = () => {
      ...
      const renderWrap = (
        <div ref={tabListRef} className={tablistCls} style={listPositionStyle}>
          {childrenToRender}
          {renderActiveLine()}
        </div>
      )
