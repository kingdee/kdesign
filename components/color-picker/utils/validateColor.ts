...
export function validateColor(color: string): string {
  ...
  const hsbReg = /^hsb\(\s*(-?\d+|-?\d*\.\d+)(?:,\s*(-?\d+|-?\d*\.\d+)){2}\s*\)$/
  const hsbaReg = /^hsba\(\s*(-?\d+|-?\d*\.\d+)(?:,\s*(-?\d+|-?\d*\.\d+)){2}\s*,\s*(-?\d+|-?\d*\.\d+)\)$/
  ...
  const hslReg = /^hsl\(\s*(-?\d+|-?\d*\.\d+)(?:,\s*(-?\d+|-?\d*\.\d+)){2}\s*\)$/
  const hslaReg = /^hsla\(\s*(-?\d+|-?\d*\.\d+)(?:,\s*(-?\d+|-?\d*\.\d+)){2}\s*,\s*(-?\d+|-?\d*\.\d+)\)$/
