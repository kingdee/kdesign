...
function Demo() {
  ...
  const [defaultCountry,setDefaultCountry] = React.useState<IGeoZonePickerProps['defaultCountry']>('001')
  const [geoZoneData,setGeoZoneData] = React.useState<IGeoZonePickerProps['tabOptions']>(null)
