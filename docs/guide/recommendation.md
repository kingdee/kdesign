...
| 类型 | 推荐组件 |
| --- | --- |
| 可视化图表 | [KDesign Charts](https://charts.kingdee.design/) [echarts-for-react](https://github.com/hustcc/echarts-for-react) [reactflow](https://reactflow.dev/) |
...
| 拖拽 | [dnd-kit](https://github.com/clauderic/dnd-kit) [react-beautiful-dnd](https://github.com/atlassian/react-beautiful-dnd/) [react-dnd](https://github.com/gaearon/react-dnd) [react-sortablejs](https://github.com/SortableJS/react-sortablejs) |
...
| 富文本编辑器 | [react-quill](https://github.com/zenoamaro/react-quill) [tinymce-react](https://github.com/tinymce/tinymce-react) |
...
| 应用程序框架 | [kdesign-pro](https://pro.kingdee.design/) [umi](https://github.com/umijs/umi/) [remix](https://github.com/remix-run/remix) [refine](https://github.com/pankod/refine) |
